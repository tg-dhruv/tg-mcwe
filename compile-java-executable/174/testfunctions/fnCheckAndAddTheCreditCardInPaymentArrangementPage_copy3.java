...
class fncheckandaddthecreditcardinpaymentarrangementpage_copy3 {

	public static void fncheckandaddthecreditcardinpaymentarrangementpage_copy3() {
		tg.wait(15);
		if(tg.performAssert("ele_AddCard", ComparisonType.IS_VISIBLE)){
		tg.click("ele_AddCard");
		tg.testFunction("fnCCDetails_copy3", new Object[]{});
		tg.wait(15);
