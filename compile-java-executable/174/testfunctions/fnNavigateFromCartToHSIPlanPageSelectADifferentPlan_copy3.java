...
class fnnavigatefromcarttohsiplanpageselectadifferentplan_copy3 {

	public static void fnnavigatefromcarttohsiplanpageselectadifferentplan_copy3() {
		tg.wait(15);
		if(tg.performAssert("ele_YourCartIsEmptyText", ComparisonType.IS_INVISIBLE)){
