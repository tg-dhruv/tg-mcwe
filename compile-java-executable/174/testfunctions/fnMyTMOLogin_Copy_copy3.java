...
class fnmytmologin_copy_copy3 {

	public static void fnmytmologin_copy_copy3() {
		...
		tg.type("ele_emailOrPhoneInput", "Vault_HashiCorp_TMOUserNameTest@@tmobile/APM0103858/shared/accounts/resource/tlifeautomation");
		tg.wait("ele_nextButton", ComparisonType.IS_VISIBLE, 5);
		tg.click("ele_nextButton", 1);
		tg.wait(20);
		tg.testFunction("fnHandleLoginWithPasswordButton_copy3", new Object[]{});
		...
		tg.type("ele_passwordInput", "Vault_HashiCorp_TMOPasswordTest@@tmobile/APM0103858/shared/accounts/resource/tlifeautomation");
