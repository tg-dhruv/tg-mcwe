...
public class digital_mytmoweb_home_manage_bill_acceptabledaterangeselectionforuser_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_manage_bill_acceptabledaterangeselectionforuser_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnCheckAutoPayAndClick_copy3");
		// [DISABLED] tg.testFunction("fnSelectDateRangeInManageAutopay_copy3");
		tg.testFunction("fnValidatePayementDateDropDownAndSelectADifferentDate_copy3");
