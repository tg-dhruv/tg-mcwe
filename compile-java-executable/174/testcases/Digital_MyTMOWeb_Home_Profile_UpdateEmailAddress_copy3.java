...
public class digital_mytmoweb_home_profile_updateemailaddress_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_updateemailaddress_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnNavigateToProfileTab_copy3");
		tg.testFunction("fnClickOnBillingPreferences_copy3");
		tg.testFunction("fnClickPaperlessBilling_copy3");
		tg.testFunction("fnClickUpdateEmail_copy3");
		tg.testFunction("fnEnterEmailAddressAndSave_copy3");
