...
public class digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPastBills_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
		tg.testFunction("fnClickOnPastBillsDetailedPDF_copy3");
		tg.testFunction("fnManageDownloads_copy3");
