...
public class digital_mytmoweb_home_profile_updatebillingaddress_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_updatebillingaddress_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnUpdateBillingAddress_copy3", new Object[]{});
		// [DISABLED] tg.testFunction("fnlogoutRestored_copy3", new Object[]{});
		tg.close();
	}
}