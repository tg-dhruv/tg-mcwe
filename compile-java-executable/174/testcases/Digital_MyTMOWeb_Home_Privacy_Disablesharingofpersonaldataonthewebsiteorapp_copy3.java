...
public class digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPersonalInformation_copy3");
		tg.switchToTab(1);
		tg.testFunction("fnValidateAndPerformDisableInfoShare_copy3");
		tg.switchToTab(0);
