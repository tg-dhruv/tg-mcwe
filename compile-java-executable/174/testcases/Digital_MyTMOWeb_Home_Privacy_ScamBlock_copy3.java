...
public class digital_mytmoweb_home_privacy_scamblock_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_scamblock_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnBlockScam_copy3");
		tg.testFunction("fnValidateAndEnableScamCalls_copy3");
