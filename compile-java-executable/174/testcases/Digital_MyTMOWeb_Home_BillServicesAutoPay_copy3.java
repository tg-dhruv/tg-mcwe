...
public class digital_mytmoweb_home_billservicesautopay_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_billservicesautopay_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickManageAutoPayUnderBillingService_copy3");
		tg.testFunction("fnVerifyPaymentMethodInAutoPay_copy3");
		tg.testFunction("fnVerifyCancelAutoPayInAutoPay_copy3");
