...
public class digital_mytmoweb_home_privacy_toggleswitchoff_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_toggleswitchoff_copy3() {
		tg.openBrowser();
		...
		tg.switchToTab(1);
		tg.testFunction("fnTurnOnToggle_copy3");
