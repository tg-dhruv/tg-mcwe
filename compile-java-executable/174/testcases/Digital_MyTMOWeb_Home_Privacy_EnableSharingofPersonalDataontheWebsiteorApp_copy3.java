...
public class digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickDoNotSellorShareData_copy3");
		tg.testFunction("fnDoNotSellorShareData_copy3");
		tg.testFunction("fnDoNotSellorShareData_off_copy3");
		tg.close();
	}
}