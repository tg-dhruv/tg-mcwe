...
public class digital_mytmoweb_home_bill_updateinstallmentsdatesofpatoincludeadditionaloffereddate_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_updateinstallmentsdatesofpatoincludeadditionaloffereddate_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSetupaPaymentArrangement_copy3");
		tg.testFunction("fnCheckAndAddTheCreditCardInPaymentArrangementPage_copy3");
		tg.wait(20);
		...
		tg.click("ele_TlogoHomeNavigator", 1);
		tg.wait(15);
		tg.testFunction("fnRemovePaymentArrangement_copy3");
		tg.close();
	}
}