...
public class digital_mytmoweb_home_plan_seethefullplandetails_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_plan_seethefullplandetails_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnFullPlanDetails_copy3");
		tg.close();
	}
}