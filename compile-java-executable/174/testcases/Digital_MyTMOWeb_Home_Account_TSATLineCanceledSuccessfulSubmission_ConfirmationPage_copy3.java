...
public class digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy3() {
		tg.openBrowser();
		var_Username = tg.saveToVariable("4702575877", var_Username);
		...
		tg.testFunction("fn10dollarTSatelliteCancelflow_copy3");
		tg.wait(1);
		tg.close();
	}
}