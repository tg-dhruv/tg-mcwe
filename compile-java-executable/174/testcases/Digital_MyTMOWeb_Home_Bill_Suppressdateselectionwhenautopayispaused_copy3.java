...
public class digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnManagePaymentArrangement_copy3");
		tg.testFunction("fnAddPA_copy3");
		tg.testFunction("fnAutoPayErrorValidation_copy3");
		tg.wait("ele_backBtC", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_backBtC", 1);
		tg.testFunction("fnClickViewBill_copy3");
		tg.testFunction("fnClickOnManagePaymentArrangement_copy3");
		tg.testFunction("fnDeletePA_copy3");
