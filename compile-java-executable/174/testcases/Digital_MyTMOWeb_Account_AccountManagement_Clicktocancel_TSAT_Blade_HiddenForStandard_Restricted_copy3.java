...
public class digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_blade_hiddenforstandard_restricted_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_blade_hiddenforstandard_restricted_copy3() {
		tg.openBrowser();
		...
		tg.wait(10);
		tg.check.isInvisible("ele_CancelTSatelliteService");
		tg.printLogs("The cancel option should be invisible for T-Satellite restricted users.");
