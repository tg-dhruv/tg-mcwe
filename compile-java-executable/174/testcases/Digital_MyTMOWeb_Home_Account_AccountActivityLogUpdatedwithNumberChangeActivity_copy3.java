...
public class digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnAccountActivity_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
		tg.takeFullScreenshot();
		tg.testFunction("fnValidateTimeStamp_copy3");
