...
public class digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnAssertBillAmountisEqualorLessthanZero_copy3");
		tg.testFunction("fnClickViewBill_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
		tg.testFunction("fnotherAmount_100_copy3");
		// [DISABLED] tg.testFunction("fnEnterCardDetails_copy3");
		tg.close();
	}
}