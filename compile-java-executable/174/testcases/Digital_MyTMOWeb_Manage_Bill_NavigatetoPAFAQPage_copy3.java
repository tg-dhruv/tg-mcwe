...
public class digital_mytmoweb_manage_bill_navigatetopafaqpage_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_manage_bill_navigatetopafaqpage_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSetupaPaymentArrangement_copy3", new Object[]{});
		tg.testFunction("fnCheckAndAddTheCreditCardInPaymentArrangementPage_copy3", new Object[]{});
		tg.wait(20);
		...
		tg.testFunction("fnValidatePAFAQPage_copy3", new Object[]{});
		tg.testFunction("fnClickBackButton_copy3", new Object[]{});
		tg.testFunction("fnClickBackButton_copy3", new Object[]{});
		tg.wait("ele_TlogoHomeNavigator", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_TlogoHomeNavigator", 1);
		tg.testFunction("fnRemovePaymentArrangement_copy3", new Object[]{});
		tg.close();
	}
}