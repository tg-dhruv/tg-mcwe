...
public class digital_mytmoweb_home_bill_viewservicedetails_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewservicedetails_copy3() {
		tg.openBrowser();
				...
				tg.testFunction("fnNavigatetoViewServicesDetails_copy3");
		tg.close();
	}
}