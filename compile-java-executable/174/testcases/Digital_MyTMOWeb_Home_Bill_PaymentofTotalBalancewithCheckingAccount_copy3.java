...
public class digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnTotalBalance_copy3");
		tg.testFunction("fnClickOnAddPaymentMethod_copy3");
		tg.testFunction("fnClickOnBank_copy3");
		tg.testFunction("fnClickOnEnterAccountDetailsManually_copy3");
		// [DISABLED] tg.testFunction("fnFillTheAccountDetails_copy3");
