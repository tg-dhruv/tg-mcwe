...
public class digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnAssertBillAmountisGreaterthanZero_copy3");
		tg.testFunction("fnClickViewBill_copy3");
		tg.testFunction("fnOtherAmount_copy3");
		tg.testFunction("fnEnterCardDetails_copy3");
		tg.close();
	}
}