...
public class digital_mytmoweb_home_privacy_blocktmomailnetemail_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blocktmomailnetemail_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnBlockTMOmail_copy3");
		tg.testFunction("fnBlockTMOmail_copy3");
		tg.close();
	}
}