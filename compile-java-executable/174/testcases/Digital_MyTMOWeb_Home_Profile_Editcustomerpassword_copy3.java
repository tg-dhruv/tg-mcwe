...
public class digital_mytmoweb_home_profile_editcustomerpassword_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editcustomerpassword_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnChangePassword_copy3");
		tg.close();
	}
}