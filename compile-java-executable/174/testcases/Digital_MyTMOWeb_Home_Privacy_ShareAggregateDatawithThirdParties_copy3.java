...
public class digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSharedataforpublicandscientificresearch_copy3");
		tg.testFunction("fnSharedataforpublicandscientificresearch_off_copy3");
		tg.close();
	}
}