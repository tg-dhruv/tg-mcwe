...
public class digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy3() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies_copy3");
		tg.testFunction("fnNaviagteToPrivacyTab_copy3");
		tg.testFunction("fnBloclcallsnMessages_copy3");
		// [DISABLED] tg.testFunction("fnBlockCallsandMessages_on_copy3");
		tg.testFunction("fnDeviceBlock_copy3");
		tg.testFunction("fnDeviceBlock_copy3");
		tg.close();
	}
}