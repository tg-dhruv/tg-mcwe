...
public class digital_mytmoweb_home_privacy_landonprivacynoticetab_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_landonprivacynoticetab_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickPrivacyNotice_copy3");
		tg.close();
	}
}