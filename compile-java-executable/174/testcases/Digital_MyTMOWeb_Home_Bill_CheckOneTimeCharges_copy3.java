...
public class digital_mytmoweb_home_bill_checkonetimecharges_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_checkonetimecharges_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnNavigateToOneTimeCharges_copy3");
		tg.close();
	}
}