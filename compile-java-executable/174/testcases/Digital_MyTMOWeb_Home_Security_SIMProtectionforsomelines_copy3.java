...
public class digital_mytmoweb_home_security_simprotectionforsomelines_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_security_simprotectionforsomelines_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSIMProtectionforSomelines_copy3");
