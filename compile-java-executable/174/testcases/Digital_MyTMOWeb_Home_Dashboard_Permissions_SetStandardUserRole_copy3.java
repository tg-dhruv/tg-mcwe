...
public class digital_mytmoweb_home_dashboard_permissions_setstandarduserrole_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_dashboard_permissions_setstandarduserrole_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickPermissionAndControl_copy3");
		tg.testFunction("fnClickUserRoles_copy3");
		tg.testFunction("fnSetstandardUserRole_copy3");
		tg.testFunction("fnSetAuthorizedRole_copy3");
