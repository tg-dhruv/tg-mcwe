...
public class digital_mytmoweb_home_bill_viewpastbillsummarypage_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewpastbillsummarypage_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnRecentPastBills_copy3");
		// [DISABLED] tg.testFunction("fnClickBackButton_copy3");
