...
public class digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddAHomeInternetToTheCart_copy3", new Object[]{});
		tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy3", new Object[]{});
		tg.testFunction("fnVerifyTheOSMessageContain2CTAContinueAndCancel_copy3", new Object[]{});
		...
		tg.testFunction("fnRemoveTheLineFromTheCart_copy3", new Object[]{});
		// [DISABLED] tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy3", new Object[]{});
		// [DISABLED] tg.wait(15);
