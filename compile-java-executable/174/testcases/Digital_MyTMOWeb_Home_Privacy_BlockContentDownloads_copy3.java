...
public class digital_mytmoweb_home_privacy_blockcontentdownloads_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blockcontentdownloads_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnBlockContentDownloads_copy3");
		tg.wait(10);
		tg.testFunction("fnBlockContentDownloads_copy3");
		tg.close();
	}
