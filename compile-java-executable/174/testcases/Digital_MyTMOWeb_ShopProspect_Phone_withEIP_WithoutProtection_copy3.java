...
public class digital_mytmoweb_shopprospect_phone_witheip_withoutprotection_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shopprospect_phone_witheip_withoutprotection_copy3() {
		tg.openBrowser();
		tg.testFunction("fnClickOnPhonesProspect_copy3", new Object[]{});
		...
		tg.testFunction("fnClickGetNewNumber_copy3", new Object[]{});
		tg.testFunction("fnSkipTradeInProspect_copy3", new Object[]{});
		tg.testFunction("fnDeclineProtectionProspect_copy3", new Object[]{});
		tg.testFunction("fnClickOnAdddToCartProspect_copy3", new Object[]{});
		tg.testFunction("fnSelectNumberOfLinesProspect_copy3", new Object[]{});
		tg.wait(20);
		tg.close();
	}
}