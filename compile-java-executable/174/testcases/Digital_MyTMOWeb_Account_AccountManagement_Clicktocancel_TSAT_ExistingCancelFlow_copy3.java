...
public class digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateTSatelliteCancelPage_copy3", new Object[]{});
		tg.close();
	}
}