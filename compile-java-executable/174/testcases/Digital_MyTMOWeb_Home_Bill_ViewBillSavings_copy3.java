...
public class digital_mytmoweb_home_bill_viewbillsavings_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewbillsavings_copy3() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnLogout_copy3");
		tg.close();
	}
}