...
public class digital_mytmoweb_home_privacy_landonprivacycentertab_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_landonprivacycentertab_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPrivacyCenter_copy3");
		tg.switchToTab(1);
		tg.testFunction("fnValidatePrivacyCenter_copy3");
		tg.switchToTab(0);
