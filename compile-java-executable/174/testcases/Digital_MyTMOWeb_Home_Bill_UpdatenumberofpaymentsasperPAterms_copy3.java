...
public class digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSplitinstalmentinPA_copy3", new Object[]{});
		tg.close();
	}
}