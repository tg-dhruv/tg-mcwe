...
public class digital_mytmoweb_home_plan_navigatetorateplanchange_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_plan_navigatetorateplanchange_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnViewPlanDetails_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
		tg.testFunction("fnCheckRatePlanChange_copy3");
