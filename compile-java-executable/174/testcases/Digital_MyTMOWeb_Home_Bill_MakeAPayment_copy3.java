...
public class digital_mytmoweb_home_bill_makeapayment_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makeapayment_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnDismissNotificationPopUps_copy3");
		tg.testFunction("fnNavigatenVerifyMakepayment_copy3");
		tg.testFunction("fnVerifyPayment_copy3");
