...
public class digital_mytmoweb_home_bill_billbreakdownbyline_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_billbreakdownbyline_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateMultilineBillBreakDown_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
