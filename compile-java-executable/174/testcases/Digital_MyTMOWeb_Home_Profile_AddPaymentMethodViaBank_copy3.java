...
public class digital_mytmoweb_home_profile_addpaymentmethodviabank_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_addpaymentmethodviabank_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddBankAccount_copy3", new Object[]{});
		tg.testFunction("fnFillTheAccountDetails_copy3", new Object[]{});
		tg.testFunction("fnConfirmBankAccountDetails_copy3", new Object[]{});
		tg.close();
	}
}