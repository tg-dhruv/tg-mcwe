...
public class digital_mytmoweb_home_permissions_blockchargedinternationalroaming_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_blockchargedinternationalroaming_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnInternationalRoaming_copy3");
		tg.testFunction("fnBlockInternationalChargedRoaming_copy3");
		tg.close();
	}
}