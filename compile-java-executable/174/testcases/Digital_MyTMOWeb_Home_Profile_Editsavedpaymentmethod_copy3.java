...
public class digital_mytmoweb_home_profile_editsavedpaymentmethod_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editsavedpaymentmethod_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPaymentMethods_copy3");
		tg.testFunction("fnClickOnMasterCardEditButton_copy3");
		tg.testFunction("fnClickBackButton_copy3");
		tg.close();
	}
}