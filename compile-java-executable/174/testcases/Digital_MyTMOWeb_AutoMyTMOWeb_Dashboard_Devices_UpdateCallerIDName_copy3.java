...
public class digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickDeviceSettings_copy3");
		tg.testFunction("fnClickOnCallerIdName_copy3");
		tg.testFunction("fnUpdateFirstAndLastName_copy3");
