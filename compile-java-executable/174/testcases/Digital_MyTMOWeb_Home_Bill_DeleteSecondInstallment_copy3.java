...
public class digital_mytmoweb_home_bill_deletesecondinstallment_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_deletesecondinstallment_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickSetupPaymentArrangement_copy3");
		tg.testFunction("fnValidatePaymentSchedule_copy3");
