...
public class digital_mytmoweb_home_permissions_enableallowallroaming_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_enableallowallroaming_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateAllowRoamingOption_copy3");
		tg.close();
	}
}