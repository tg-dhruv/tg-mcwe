...
public class digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnManageAddons_copy3");
		tg.testFunction("fnSelectAnotherLine_copy3");
		tg.testFunction("fnMultilineAddon_copy3");
		tg.testFunction("fnSelectAnotherLine_copy3");
		tg.testFunction("fnMultilineAddonRemoval_copy3");
		tg.testFunction("fnNewLogout_copy3");
		tg.close();
	}
}