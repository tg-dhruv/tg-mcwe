...
public class digital_mytmoweb_home_bill_changeattributeofexistingpawithoutupdatingpaymentmethod_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_changeattributeofexistingpawithoutupdatingpaymentmethod_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnUpdatePA_date_copy3");
		tg.testFunction("fnClickViewBill_copy3");
		tg.testFunction("fnClickOnManagePaymentArrangement_copy3");
