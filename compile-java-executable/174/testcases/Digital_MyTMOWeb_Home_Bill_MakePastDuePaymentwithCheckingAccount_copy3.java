...
public class digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy3() {
		tg.openBrowser();
		var_Username = tg.saveToVariable("4706624138", var_Username);
		var_Password = tg.saveToVariable("Tmobile@2144", var_Password);
		tg.testFunction("fnDigitalWebLoginPRODPastDueAccount_copy3");
		tg.testFunction("fnAcceptCookies_copy3");
		tg.testFunction("fnClickViewBill_copy3");
		tg.testFunction("fnNavigatePayment_copy3");
		tg.click("ele_bankpreferred", 1);
		// [DISABLED] tg.testFunction("fnClickOnPayment_copy3");
		tg.testFunction("fnClickOnEnterAccountDetailsManually_copy3");
		tg.testFunction("fnBankAccountDetails_copy3");
		// [DISABLED] tg.testFunction("fnConfirmBankAccountDetails_copy3");
		tg.close();
	}
}