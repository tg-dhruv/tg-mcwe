...
public class digital_mytmoweb_home_bill_user_switch_payment_from_secure_to_unsecure_and_viceversa_before_1st_in_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_user_switch_payment_from_secure_to_unsecure_and_viceversa_before_1st_in_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickSeeAllScheduledArrangements_copy3");
		tg.testFunction("fnDontAllowNotificationPopUp_copy3");
		tg.testFunction("fnCloseSomethingBehindPopup_copy3");
		// [DISABLED] tg.testFunction("fnEditAutoPaymentMethod_copy3");
		tg.testFunction("fnClickOnEditPaymentMethod_copy3");
		tg.wait(15);
		...
		tg.testFunction("fnClickUnsecurePayment_copy3");
		...
		// [DISABLED] tg.testFunction("fnRemovePaymentArrangement_copy3");
		tg.close();
	}
}