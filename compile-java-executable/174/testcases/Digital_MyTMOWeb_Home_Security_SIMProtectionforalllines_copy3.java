...
public class digital_mytmoweb_home_security_simprotectionforalllines_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_security_simprotectionforalllines_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnSIMProtectionforAlllines_copy3");
