...
public class digital_mytmoweb_home_permissions_landonfamilycontrols_copy3 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_landonfamilycontrols_copy3() {
		tg.openBrowser();
		...
		tg.testFunction("fnnavigatetoprofile_copy3");
		tg.testFunction("fnFamilyControl_copy3");
		tg.close();
	}
}