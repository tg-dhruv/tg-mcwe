...
public class Step1_Update_Attributes_Coach_999e54fe extends tc_Step1_1480d125 {

	@Test
	public void step1_update_attributes_coach_999e54fe() {
		tg.openBrowser();
		tg.testFunction("login_tg_global_functions");
		// [DISABLED] tg.wait(10);
		// [DISABLED] tg.type("ele_IchEmployeeIdFKempId_3a11539e", "PDTS1Coach0022");
		// [DISABLED] tg.click("ele_IchGoButton_3a11539e", 1);
		// [DISABLED] tg.wait(15);
		// [DISABLED] tg.type("ele_IchDTSJobTitle_3a12b1ce", "Cre Coach");
		...
		// [DISABLED] tg.wait(15);
		tg.type("ele_Search_3a2161be", "PDTS1Coach0022");
		tg.pressKey(ENTER, 1);
		tg.wait(15);
		tg.click("ele_JobTitle_3a219534", 1);
		tg.type("ele_JobTitleOption_3a219534", "CRE COACH");
		...
		tg.type("ele_DepartmentOption_3a219539", "Closed Loop Outbound");
		tg_String var_date1 = "";
