...
public class Step1_Verify_EmployeeDetails_Manager extends tc_Step1_1480d125 {

	@Test
	public void step1_verify_employeedetails_manager() {
		tg.openBrowser();
		...
		// [DISABLED] tg.wait(15);
		tg.type("ele_Search_3a2161be", "PDTS1Manager0021");
		tg.pressKey(ENTER, 1);
		tg.wait(15);
