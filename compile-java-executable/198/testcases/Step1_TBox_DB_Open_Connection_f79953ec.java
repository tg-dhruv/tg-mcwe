...
public class Step1_TBox_DB_Open_Connection_f79953ec extends tc_Step1_1480d125 {

	@Test
	public void step1_tbox_db_open_connection_f79953ec() {
		tg.openBrowser();
		tg.testFunction("login_tg_global_functions");
		// [DISABLED] // Tosca: Connection name | VERINT QLAB03 | (ActionMode 37)
		...
		// [DISABLED] // Tosca: Connection string | {CP[ICHConnectionStringPPD]} | (ActionMode 37)
