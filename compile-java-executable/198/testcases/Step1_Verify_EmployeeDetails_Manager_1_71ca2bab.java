...
public class Step1_Verify_EmployeeDetails_Manager_1_71ca2bab extends tc_Step1_1480d125 {

	@Test
	public void step1_verify_employeedetails_manager_1_71ca2bab() {
		tg.openBrowser();
		...
		// [DISABLED] tg.wait(15);
		tg.type("ele_Search_3a2161be", "PDTS1Manager10022");
		tg.pressKey(ENTER, 1);
		tg.wait(15);
