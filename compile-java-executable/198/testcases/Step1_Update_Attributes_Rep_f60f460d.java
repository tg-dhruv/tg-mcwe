...
public class Step1_Update_Attributes_Rep_f60f460d extends tc_Step1_1480d125 {

	@Test
	public void step1_update_attributes_rep_f60f460d() {
		tg.openBrowser();
		tg.testFunction("login_tg_global_functions");
		// [DISABLED] tg.wait(10);
		// [DISABLED] tg.type("ele_IchEmployeeIdFKempId_3a11539e", "PDTS1Rep0022");
		...
		// [DISABLED] tg.wait(15);
		tg.type("ele_Search_3a2161be", "PDTS1Rep0022");
		tg.pressKey(ENTER, 1);
		tg.wait(15);
		tg.click("ele_JobTitle_3a219534", 1);
		tg.type("ele_JobTitleOption_3a219534", "ELITE EXPERT");
