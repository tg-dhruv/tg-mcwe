...
public class Step1_Update_Attributes_Coach extends tc_Step1_1480d125 {

	@Test
	public void step1_update_attributes_coach() {
		tg.openBrowser();
		tg.testFunction("login_tg_global_functions");
		// [DISABLED] tg.wait(10);
		// [DISABLED] tg.type("ele_IchEmployeeIdFKempId_3a11539e", "PDTS1Coach0021");
		...
		// [DISABLED] tg.wait(15);
		tg.type("ele_Search_3a2161be", "PDTS1Coach0021");
		tg.pressKey(ENTER, 1);
		tg.wait(15);
