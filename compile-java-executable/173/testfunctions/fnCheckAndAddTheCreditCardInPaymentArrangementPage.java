...
class fncheckandaddthecreditcardinpaymentarrangementpage {

	public static void fncheckandaddthecreditcardinpaymentarrangementpage() {
		tg.wait(15);
		if(tg.performAssert("ele_AddCard", ComparisonType.IS_VISIBLE)){
		tg.click("ele_AddCard");
		tg.testFunction("fnCCDetails", new Object[]{});
		tg.wait(15);
