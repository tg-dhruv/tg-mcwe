...
class fncheckandaddthecreditcardinpaymentarrangementpage_copy2 {

	public static void fncheckandaddthecreditcardinpaymentarrangementpage_copy2() {
		tg.wait(15);
		if(tg.performAssert("ele_AddCard", ComparisonType.IS_VISIBLE)){
		tg.click("ele_AddCard");
		tg.testFunction("fnCCDetails_copy2", new Object[]{});
		tg.wait(15);
