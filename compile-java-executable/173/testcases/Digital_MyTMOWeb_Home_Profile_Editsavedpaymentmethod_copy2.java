...
public class digital_mytmoweb_home_profile_editsavedpaymentmethod_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editsavedpaymentmethod_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnMasterCardEditButton_copy2");
