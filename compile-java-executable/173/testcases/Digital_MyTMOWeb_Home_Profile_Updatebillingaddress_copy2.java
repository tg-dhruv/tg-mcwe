...
public class digital_mytmoweb_home_profile_updatebillingaddress_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_updatebillingaddress_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnUpdateBillingAddress_copy2", new Object[]{});
		// [DISABLED] tg.testFunction("fnlogoutRestored_copy2", new Object[]{});
		tg.close();
	}
}