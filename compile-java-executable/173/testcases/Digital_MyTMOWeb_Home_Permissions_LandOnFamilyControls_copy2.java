...
public class digital_mytmoweb_home_permissions_landonfamilycontrols_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_landonfamilycontrols_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnnavigatetoprofile_copy2");
		tg.testFunction("fnFamilyControl_copy2");
		tg.close();
	}
}