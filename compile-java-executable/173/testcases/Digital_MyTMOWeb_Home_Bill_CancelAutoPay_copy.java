...
public class digital_mytmoweb_home_bill_cancelautopay_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_cancelautopay_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnVerifyCancelAutoPayInAutoPay_copy", new Object[]{});
