...
public class digital_mytmoweb_home_privacy_landonprivacynoticetab_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_landonprivacynoticetab_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickPrivacyNotice_copy2");
		tg.close();
	}
}