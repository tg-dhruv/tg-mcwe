...
public class digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount {
	...
	public void digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount() {
		...
		tg.testFunction("fnDigitalWebLoginPRODPastDueAccount");
		tg.testFunction("fnAcceptCookies");
		tg.testFunction("fnClickViewBill");
		tg.testFunction("fnNavigatePayment");
		tg.click("ele_bankpreferred", 1);
		// [DISABLED] tg.testFunction("fnClickOnPayment");
		tg.testFunction("fnClickOnEnterAccountDetailsManually");
		tg.testFunction("fnBankAccountDetails");
