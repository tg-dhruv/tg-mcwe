...
public class digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnAccountActivity_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.takeFullScreenshot();
		tg.testFunction("fnValidateTimeStamp_copy2");
