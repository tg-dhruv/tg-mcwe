...
public class digital_mytmoweb_home_bill_user_switch_payment_from_secure_to_unsecure_and_viceversa_before_1st_in_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_user_switch_payment_from_secure_to_unsecure_and_viceversa_before_1st_in_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnCloseSomethingBehindPopup_copy");
		// [DISABLED] tg.testFunction("fnEditAutoPaymentMethod_copy");
		tg.testFunction("fnClickOnEditPaymentMethod_copy");
		tg.wait(15);
		...
		tg.testFunction("fnClickUnsecurePayment_copy");
		...
		// [DISABLED] tg.testFunction("fnRemovePaymentArrangement_copy");
		tg.close();
	}
}