...
public class digital_mytmoweb_home_bill_navigatetoaccountdiscountspage_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_navigatetoaccountdiscountspage_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnDiscountsandPromotions_copy2");
