...
public class digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod {
	...
	public void digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod() {
		...
		tg.testFunction("fnAssertBillAmountisEqualorLessthanZero");
		tg.testFunction("fnClickViewBill");
		tg.testFunction("fnDontAllowNotificationPopUp");
		tg.testFunction("fnotherAmount_100");
		// [DISABLED] tg.testFunction("fnEnterCardDetails");
		tg.close();
	}
}