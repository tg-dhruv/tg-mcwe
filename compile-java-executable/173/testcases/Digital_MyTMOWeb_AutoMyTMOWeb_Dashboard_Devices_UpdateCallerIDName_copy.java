...
public class digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnNavigateToProfileTab_copy");
		tg.testFunction("fnClickDeviceSettings_copy");
		tg.testFunction("fnClickOnCallerIdName_copy");
		tg.testFunction("fnUpdateFirstAndLastName_copy");
