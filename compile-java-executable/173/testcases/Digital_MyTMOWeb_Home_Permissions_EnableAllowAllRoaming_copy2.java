...
public class digital_mytmoweb_home_permissions_enableallowallroaming_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_enableallowallroaming_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateAllowRoamingOption_copy2");
		tg.close();
	}
}