...
public class digital_mytmoweb_home_bill_deletesecondinstallment_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_deletesecondinstallment_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickSetupPaymentArrangement_copy2");
		tg.testFunction("fnValidatePaymentSchedule_copy2");
