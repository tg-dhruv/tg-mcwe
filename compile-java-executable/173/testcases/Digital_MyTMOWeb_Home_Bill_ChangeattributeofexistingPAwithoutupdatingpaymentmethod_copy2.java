...
public class digital_mytmoweb_home_bill_changeattributeofexistingpawithoutupdatingpaymentmethod_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_changeattributeofexistingpawithoutupdatingpaymentmethod_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnUpdatePA_date_copy2");
		tg.testFunction("fnClickViewBill_copy2");
		tg.testFunction("fnClickOnManagePaymentArrangement_copy2");
