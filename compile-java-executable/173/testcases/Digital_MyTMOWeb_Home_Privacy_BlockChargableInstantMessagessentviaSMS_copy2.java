...
public class digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy2() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies_copy2");
		tg.testFunction("fnNaviagteToPrivacyTab_copy2");
		tg.testFunction("fnBloclcallsnMessages_copy2");
		// [DISABLED] tg.testFunction("fnBlockCallsandMessages_on_copy2");
		tg.testFunction("fnDeviceBlock_copy2");
		tg.testFunction("fnDeviceBlock_copy2");
		tg.close();
	}
}