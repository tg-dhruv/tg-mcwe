...
public class digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateTSatelliteCancelPage_copy", new Object[]{});
		tg.close();
	}
}