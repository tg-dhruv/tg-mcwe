...
public class digital_mytmoweb_home_profile_editcustomerphonenumber_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editcustomerphonenumber_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickDeviceSettings_copy2");
		tg.testFunction("fnClickOnUsageAddress_copy2");
		tg.testFunction("fnUpdateUsageAddress_copy2");
