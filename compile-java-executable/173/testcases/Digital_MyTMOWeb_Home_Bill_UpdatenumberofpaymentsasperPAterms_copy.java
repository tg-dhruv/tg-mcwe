...
public class digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnSplitinstalmentinPA_copy", new Object[]{});
		tg.close();
	}
}