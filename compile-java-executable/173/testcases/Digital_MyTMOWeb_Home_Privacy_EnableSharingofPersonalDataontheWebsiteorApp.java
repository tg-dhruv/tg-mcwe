...
public class digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp {
	...
	public void digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp() {
		...
		tg.testFunction("fnClickPrivacy");
		tg.testFunction("fnClickDoNotSellorShareData");
		tg.testFunction("fnDoNotSellorShareData");
		tg.testFunction("fnDoNotSellorShareData_off");
		tg.close();
	}
}