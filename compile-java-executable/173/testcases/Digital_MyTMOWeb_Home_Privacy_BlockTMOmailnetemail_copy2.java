...
public class digital_mytmoweb_home_privacy_blocktmomailnetemail_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blocktmomailnetemail_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnBlockTMOmail_copy2");
		tg.testFunction("fnBlockTMOmail_copy2");
		tg.close();
	}
}