...
public class digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnCallerIdName_copy2");
		tg.testFunction("fnUpdateFirstAndLastName_copy2");
