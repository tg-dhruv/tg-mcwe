...
public class digital_mytmoweb_manage_bill_navigatetopafaqpage_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_manage_bill_navigatetopafaqpage_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickViewBill_copy2", new Object[]{});
		...
		tg.testFunction("fnSetupaPaymentArrangement_copy2", new Object[]{});
		tg.testFunction("fnCheckAndAddTheCreditCardInPaymentArrangementPage_copy2", new Object[]{});
		tg.wait(20);
		...
		tg.testFunction("fnValidatePAFAQPage_copy2", new Object[]{});
		tg.testFunction("fnClickBackButton_copy2", new Object[]{});
		tg.testFunction("fnClickBackButton_copy2", new Object[]{});
		tg.wait("ele_TlogoHomeNavigator", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_TlogoHomeNavigator", 1);
		tg.testFunction("fnRemovePaymentArrangement_copy2", new Object[]{});
		tg.close();
	}
}