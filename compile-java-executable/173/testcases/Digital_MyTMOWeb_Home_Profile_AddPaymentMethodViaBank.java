...
public class digital_mytmoweb_home_profile_addpaymentmethodviabank {
	...
	public void digital_mytmoweb_home_profile_addpaymentmethodviabank() {
		...
		tg.testFunction("fnAddBankAccount", new Object[]{});
		tg.testFunction("fnFillTheAccountDetails", new Object[]{});
		tg.testFunction("fnConfirmBankAccountDetails", new Object[]{});
		tg.close();
	}
}