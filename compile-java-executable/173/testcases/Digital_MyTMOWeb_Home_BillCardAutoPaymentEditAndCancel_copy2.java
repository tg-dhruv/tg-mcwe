...
public class digital_mytmoweb_home_billcardautopaymenteditandcancel_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_billcardautopaymenteditandcancel_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnEditAutoPaymentMethod_copy2");
