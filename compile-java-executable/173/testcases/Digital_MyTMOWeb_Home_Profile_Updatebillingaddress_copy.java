...
public class digital_mytmoweb_home_profile_updatebillingaddress_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_updatebillingaddress_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnUpdateBillingAddress_copy", new Object[]{});
		// [DISABLED] tg.testFunction("fnlogoutRestored_copy", new Object[]{});
		tg.close();
	}
}