...
public class digital_mytmoweb_home_plan_seethefullplandetails_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_plan_seethefullplandetails_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnFullPlanDetails_copy2");
		tg.close();
	}
}