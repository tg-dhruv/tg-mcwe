...
public class digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnManagePaymentArrangement_copy2");
		tg.testFunction("fnAddPA_copy2");
		tg.testFunction("fnAutoPayErrorValidation_copy2");
		tg.wait("ele_backBtC", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_backBtC", 1);
		tg.testFunction("fnClickViewBill_copy2");
		tg.testFunction("fnClickOnManagePaymentArrangement_copy2");
		tg.testFunction("fnDeletePA_copy2");
