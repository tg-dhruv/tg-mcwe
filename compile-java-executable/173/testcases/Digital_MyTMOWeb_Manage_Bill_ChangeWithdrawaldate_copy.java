...
public class digital_mytmoweb_manage_bill_changewithdrawaldate_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_manage_bill_changewithdrawaldate_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnSetupAutoPay_copy");
		tg.testFunction("fnDontAllowNotificationPopUp_copy");
		tg.testFunction("fnValidatePayementDateDropDownAndSelectADifferentDate_copy");
		tg.close();
	}
}