...
public class digital_mytmoweb_home_security_simprotectionforalllines_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_security_simprotectionforalllines_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnSIMProtectionforAlllines_copy2");
