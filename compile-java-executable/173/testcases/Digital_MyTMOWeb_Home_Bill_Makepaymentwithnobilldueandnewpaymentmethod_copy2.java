...
public class digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepaymentwithnobilldueandnewpaymentmethod_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnAssertBillAmountisEqualorLessthanZero_copy2");
		tg.testFunction("fnClickViewBill_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.testFunction("fnotherAmount_100_copy2");
		// [DISABLED] tg.testFunction("fnEnterCardDetails_copy2");
		tg.close();
	}
}