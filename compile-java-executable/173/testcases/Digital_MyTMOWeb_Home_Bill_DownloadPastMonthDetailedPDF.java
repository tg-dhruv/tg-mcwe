...
public class digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf {
	...
	public void digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf() {
		...
		tg.testFunction("fnClickOnPastBills");
		tg.testFunction("fnDontAllowNotificationPopUp");
		tg.testFunction("fnClickOnPastBillsDetailedPDF");
		tg.testFunction("fnManageDownloads");
