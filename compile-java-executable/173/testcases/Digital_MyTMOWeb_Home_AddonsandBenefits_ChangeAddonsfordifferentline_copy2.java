...
public class digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnManageAddons_copy2");
		tg.testFunction("fnSelectAnotherLine_copy2");
		tg.testFunction("fnMultilineAddon_copy2");
		tg.testFunction("fnSelectAnotherLine_copy2");
		tg.testFunction("fnMultilineAddonRemoval_copy2");
		tg.testFunction("fnNewLogout_copy2");
		tg.close();
	}
}