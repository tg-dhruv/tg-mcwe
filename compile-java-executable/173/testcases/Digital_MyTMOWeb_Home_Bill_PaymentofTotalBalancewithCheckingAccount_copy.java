...
public class digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy() {
		tg.openBrowser();
