...
public class digital_mytmoweb_home_manage_bill_acceptabledaterangeselectionforuser_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_manage_bill_acceptabledaterangeselectionforuser_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnCheckAutoPayAndClick_copy2");
		// [DISABLED] tg.testFunction("fnSelectDateRangeInManageAutopay_copy2");
		tg.testFunction("fnValidatePayementDateDropDownAndSelectADifferentDate_copy2");
