...
public class digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnAssertBillAmountisGreaterthanZero_copy2");
		tg.testFunction("fnClickViewBill_copy2");
		tg.testFunction("fnOtherAmount_copy2");
		tg.testFunction("fnEnterCardDetails_copy2");
		tg.close();
	}
}