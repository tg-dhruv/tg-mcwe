...
public class digital_mytmoweb_home_bill_autopayfaqpage_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_autopayfaqpage_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnManageFAQs_copy2");
