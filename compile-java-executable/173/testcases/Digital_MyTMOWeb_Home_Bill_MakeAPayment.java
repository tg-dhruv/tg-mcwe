...
public class digital_mytmoweb_home_bill_makeapayment {
	...
	public void digital_mytmoweb_home_bill_makeapayment() {
		...
		tg.testFunction("fnDismissNotificationPopUps");
		tg.testFunction("fnNavigatenVerifyMakepayment");
		tg.testFunction("fnVerifyPayment");
