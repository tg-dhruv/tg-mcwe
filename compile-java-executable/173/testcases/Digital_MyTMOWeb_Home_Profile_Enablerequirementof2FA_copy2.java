...
public class digital_mytmoweb_home_profile_enablerequirementof2fa_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_enablerequirementof2fa_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnEnableRequirementf2FA_copy2");
