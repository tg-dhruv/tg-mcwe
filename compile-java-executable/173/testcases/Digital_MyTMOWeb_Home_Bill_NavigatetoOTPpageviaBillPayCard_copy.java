...
public class digital_mytmoweb_home_bill_navigatetootppageviabillpaycard_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_navigatetootppageviabillpaycard_copy() {
		tg.openBrowser();
