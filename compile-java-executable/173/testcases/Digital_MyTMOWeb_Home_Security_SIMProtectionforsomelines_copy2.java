...
public class digital_mytmoweb_home_security_simprotectionforsomelines_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_security_simprotectionforsomelines_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickonSecurity_copy2");
		tg.testFunction("fnSIMProtectionforSomelines_copy2");
