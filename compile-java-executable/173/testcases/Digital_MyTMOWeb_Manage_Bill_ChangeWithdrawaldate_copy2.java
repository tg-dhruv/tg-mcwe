...
public class digital_mytmoweb_manage_bill_changewithdrawaldate_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_manage_bill_changewithdrawaldate_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnSetupAutoPay_copy2");
