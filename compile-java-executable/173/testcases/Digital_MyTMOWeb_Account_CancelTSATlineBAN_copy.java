...
public class digital_mytmoweb_account_canceltsatlineban_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_canceltsatlineban_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnCancelTSATService_copy", new Object[]{});
		tg.testFunction("fnDontAllowNotificationPopUp_copy", new Object[]{});
		tg.takeFullScreenshot();
		tg.testFunction("fnCancelTSatelliteService_copy", new Object[]{});
