...
public class digital_mytmoweb_home_bill_viewpastbillsummarypage_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewpastbillsummarypage_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPastBills_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.testFunction("fnClickOnRecentPastBills_copy2");
		// [DISABLED] tg.testFunction("fnClickBackButton_copy2");
