...
public class digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnSharedataforpublicandscientificresearch_copy2");
		tg.testFunction("fnSharedataforpublicandscientificresearch_off_copy2");
		tg.close();
	}
}