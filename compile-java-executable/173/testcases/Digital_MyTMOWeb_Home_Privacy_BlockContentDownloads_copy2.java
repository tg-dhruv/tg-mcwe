...
public class digital_mytmoweb_home_privacy_blockcontentdownloads_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blockcontentdownloads_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnBlockContentDownloads_copy2");
		tg.wait(10);
		tg.testFunction("fnBlockContentDownloads_copy2");
		tg.close();
	}
