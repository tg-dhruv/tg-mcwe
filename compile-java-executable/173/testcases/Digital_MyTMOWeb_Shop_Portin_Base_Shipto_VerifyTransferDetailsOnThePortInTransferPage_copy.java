...
public class digital_mytmoweb_shop_portin_base_shipto_verifytransferdetailsontheportintransferpage_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_portin_base_shipto_verifytransferdetailsontheportintransferpage_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddMobileToCart_copy");
		tg.close();
	}
}