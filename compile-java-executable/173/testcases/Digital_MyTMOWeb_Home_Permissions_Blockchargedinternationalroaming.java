...
public class digital_mytmoweb_home_permissions_blockchargedinternationalroaming {
	...
	public void digital_mytmoweb_home_permissions_blockchargedinternationalroaming() {
		...
		tg.testFunction("fnClickOnInternationalRoaming");
		tg.testFunction("fnBlockInternationalChargedRoaming");
		tg.close();
	}
}