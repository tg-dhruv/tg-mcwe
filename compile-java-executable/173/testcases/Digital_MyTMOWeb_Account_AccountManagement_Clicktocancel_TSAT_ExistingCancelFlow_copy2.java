...
public class digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateTSatelliteCancelPage_copy2", new Object[]{});
		tg.close();
	}
}