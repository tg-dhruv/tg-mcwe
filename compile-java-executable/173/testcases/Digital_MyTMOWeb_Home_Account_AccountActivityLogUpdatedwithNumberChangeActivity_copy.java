...
public class digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_accountactivitylogupdatedwithnumberchangeactivity_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnAccountActivity_copy");
		tg.testFunction("fnDontAllowNotificationPopUp_copy");
		tg.takeFullScreenshot();
		tg.testFunction("fnValidateTimeStamp_copy");
