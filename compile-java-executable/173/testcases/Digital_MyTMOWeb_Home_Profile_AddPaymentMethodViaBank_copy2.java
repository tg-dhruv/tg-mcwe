...
public class digital_mytmoweb_home_profile_addpaymentmethodviabank_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_addpaymentmethodviabank_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddBankAccount_copy2", new Object[]{});
		tg.testFunction("fnFillTheAccountDetails_copy2", new Object[]{});
		tg.testFunction("fnConfirmBankAccountDetails_copy2", new Object[]{});
		tg.close();
	}
}