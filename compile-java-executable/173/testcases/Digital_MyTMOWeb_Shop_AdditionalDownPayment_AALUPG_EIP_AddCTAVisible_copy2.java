...
public class digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible_copy2() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies_copy2", new Object[]{});
		tg.testFunction("fnAddMobileDeviceToCartUPGWithSkipTradeInDeclineProtection_copy2", new Object[]{});
		...
		tg.testFunction("fnRemoveMobileDeviceInCartPageAndLogout_copy2", new Object[]{});
		tg.close();
	}
}