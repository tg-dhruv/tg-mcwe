...
public class digital_mytmoweb_home_bill_makepaymentwithnewcard {
	...
	public void digital_mytmoweb_home_bill_makepaymentwithnewcard() {
		...
		tg.testFunction("fnClickOnOtherAmount");
		tg.testFunction("fnEnterAmount");
		tg.testFunction("fnClickOnAddPaymentMethod");
		tg.testFunction("fnClickOnCardOption");
		// [DISABLED] tg.testFunction("fnAddCardDetails");
		// [DISABLED] tg.testFunction("fnValidatePayNowButtonIsClickable");
		tg.close();
	}
}