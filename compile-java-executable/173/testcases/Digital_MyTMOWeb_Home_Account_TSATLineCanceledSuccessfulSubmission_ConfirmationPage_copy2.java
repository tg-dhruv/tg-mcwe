...
public class digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fn10dollarTSatelliteCancelflow_copy2");
		tg.wait(1);
		tg.close();
	}
}