...
public class digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fn10dollarTSatelliteCancelflow_copy");
		tg.wait(1);
		tg.close();
	}
}