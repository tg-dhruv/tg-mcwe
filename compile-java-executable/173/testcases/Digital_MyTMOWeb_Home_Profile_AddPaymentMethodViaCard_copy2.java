...
public class digital_mytmoweb_home_profile_addpaymentmethodviacard_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_addpaymentmethodviacard_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPaymentMethods_copy2");
		tg.testFunction("fnClickOnCardOption_copy2");
		tg.testFunction("fnAddCardDetails_copy2");
		tg.testFunction("fnDeleteCardDetails_copy2");
