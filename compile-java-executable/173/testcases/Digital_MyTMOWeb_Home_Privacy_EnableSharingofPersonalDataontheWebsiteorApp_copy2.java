...
public class digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_enablesharingofpersonaldataonthewebsiteorapp_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickMyProfile_copy2");
		tg.testFunction("fnClickPrivacy_copy2");
		tg.testFunction("fnClickDoNotSellorShareData_copy2");
		tg.testFunction("fnDoNotSellorShareData_copy2");
		tg.testFunction("fnDoNotSellorShareData_off_copy2");
		tg.close();
	}
}