...
public class digital_mytmoweb_home_profile_addpaymentmethodviabank_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_addpaymentmethodviabank_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddBankAccount_copy", new Object[]{});
		tg.testFunction("fnFillTheAccountDetails_copy", new Object[]{});
		tg.testFunction("fnConfirmBankAccountDetails_copy", new Object[]{});
		tg.close();
	}
}