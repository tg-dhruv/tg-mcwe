...
public class digital_mytmoweb_home_profile_editcustomerpassword_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editcustomerpassword_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnChangePassword_copy2");
		tg.close();
	}
}