...
public class digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_tsatlinecanceledsuccessfulsubmission_confirmationpage() {
		tg.openBrowser();
		...
		tg.testFunction("fn10dollarTSatelliteCancelflow");
		tg.wait(1);
		tg.close();
	}
}