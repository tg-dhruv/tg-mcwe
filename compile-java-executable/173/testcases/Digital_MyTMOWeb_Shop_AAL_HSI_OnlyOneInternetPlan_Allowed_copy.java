...
public class digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy", new Object[]{});
		tg.testFunction("fnVerifyTheOSMessageContain2CTAContinueAndCancel_copy", new Object[]{});
		...
		tg.testFunction("fnRemoveTheLineFromTheCart_copy", new Object[]{});
		// [DISABLED] tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy", new Object[]{});
		// [DISABLED] tg.wait(15);
