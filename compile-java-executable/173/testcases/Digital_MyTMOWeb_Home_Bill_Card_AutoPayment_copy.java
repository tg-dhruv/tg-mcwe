...
public class digital_mytmoweb_home_bill_card_autopayment_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_card_autopayment_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnCheckAutoPayAndClick_copy", new Object[]{});
		if(tg.performAssert("ele_editAddressPaymentMethodAutoPay", ComparisonType.IS_VISIBLE)){
		tg.testFunction("fnDeletePaymentMethodAutoPay_copy", new Object[]{});
		tg.testFunction("fnClickViewBill_copy", new Object[]{});
		tg.testFunction("fnCheckAutoPayAndClick_copy", new Object[]{});
		}
		tg.testFunction("fnAddPaymentMethodAutoPayPage_copy", new Object[]{});
		tg.testFunction("fnClickViewBill_copy", new Object[]{});
		tg.testFunction("fnCheckAutoPayAndClick_copy", new Object[]{});
		tg.testFunction("fnEditAutoPaymentMethod_copy", new Object[]{});
		tg.testFunction("fnCheckAutoPayAndClick_copy", new Object[]{});
		tg.testFunction("fnCancelAutoPayInAutoPay_copy", new Object[]{});
		tg.testFunction("fnClickViewBill_copy", new Object[]{});
		tg.testFunction("fnCheckAutoPayAndClick_copy", new Object[]{});
		tg.testFunction("fnDeletePaymentMethodAutoPay_copy", new Object[]{});
