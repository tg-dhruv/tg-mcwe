...
public class digital_mytmoweb_home_bill_deletesecondinstallment {
	...
	public void digital_mytmoweb_home_bill_deletesecondinstallment() {
		...
		tg.testFunction("fnClickSetupPaymentArrangement");
		tg.testFunction("fnValidatePaymentSchedule");
