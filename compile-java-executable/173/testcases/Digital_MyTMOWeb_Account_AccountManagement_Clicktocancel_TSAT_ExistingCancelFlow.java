...
public class digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_accountmanagement_clicktocancel_tsat_existingcancelflow() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateTSatelliteCancelPage", new Object[]{});
		tg.close();
	}
}