...
public class digital_mytmoweb_home_billservicesautopay_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_billservicesautopay_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickManageAutoPayUnderBillingService_copy2");
		tg.testFunction("fnVerifyPaymentMethodInAutoPay_copy2");
		tg.testFunction("fnVerifyCancelAutoPayInAutoPay_copy2");
		tg.testFunction("fnClickBackButton_copy2");
