...
public class digital_mytmoweb_home_privacy_landonprivacycentertab_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_landonprivacycentertab_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPrivacyCenter_copy2");
		tg.switchToTab(1);
		tg.testFunction("fnValidatePrivacyCenter_copy2");
		tg.switchToTab(0);
