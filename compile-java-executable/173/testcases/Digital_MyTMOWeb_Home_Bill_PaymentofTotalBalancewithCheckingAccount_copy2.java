...
public class digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnMakeAPayment_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.testFunction("fnClickOnTotalBalance_copy2");
		tg.testFunction("fnClickOnAddPaymentMethod_copy2");
		tg.testFunction("fnClickOnBank_copy2");
		tg.testFunction("fnClickOnEnterAccountDetailsManually_copy2");
		// [DISABLED] tg.testFunction("fnFillTheAccountDetails_copy2");
		// [DISABLED] tg.testFunction("fnConfirmBankAccountDetails_copy2");
		tg.close();
	}
}