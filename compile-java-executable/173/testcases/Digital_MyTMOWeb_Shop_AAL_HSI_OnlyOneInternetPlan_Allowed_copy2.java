...
public class digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_aal_hsi_onlyoneinternetplan_allowed_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddAHomeInternetToTheCart_copy2", new Object[]{});
		tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy2", new Object[]{});
		tg.testFunction("fnVerifyTheOSMessageContain2CTAContinueAndCancel_copy2", new Object[]{});
		...
		tg.testFunction("fnRemoveTheLineFromTheCart_copy2", new Object[]{});
		// [DISABLED] tg.testFunction("fnNavigateFromCartToHSIPlanPageSelectADifferentPlan_copy2", new Object[]{});
		// [DISABLED] tg.wait(15);
