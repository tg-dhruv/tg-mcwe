...
public class digital_mytmoweb_home_bill_viewbillsavings_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewbillsavings_copy() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnLogout_copy");
		tg.close();
	}
}