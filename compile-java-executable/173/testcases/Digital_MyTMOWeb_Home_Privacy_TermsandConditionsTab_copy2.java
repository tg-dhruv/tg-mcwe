...
public class digital_mytmoweb_home_privacy_termsandconditionstab_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_termsandconditionstab_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnTermsAndConditions_copy2");
		tg.switchToTab(1);
		tg.testFunction("fnValidateTermsAndConditionsHeader_copy2");
		tg.switchToTab(0);
