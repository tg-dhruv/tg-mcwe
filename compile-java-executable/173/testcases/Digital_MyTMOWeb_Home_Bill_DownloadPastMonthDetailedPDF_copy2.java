...
public class digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_downloadpastmonthdetailedpdf_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.testFunction("fnClickOnPastBillsDetailedPDF_copy2");
