...
public class digital_mytmoweb_home_dashboard_permissions_setstandarduserrole_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_dashboard_permissions_setstandarduserrole_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickPermissionAndControl_copy2");
		tg.testFunction("fnClickUserRoles_copy2");
		tg.testFunction("fnSetstandardUserRole_copy2");
		tg.testFunction("fnSetAuthorizedRole_copy2");
