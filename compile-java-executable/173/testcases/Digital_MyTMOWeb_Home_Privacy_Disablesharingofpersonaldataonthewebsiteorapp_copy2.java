...
public class digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnPersonalInformation_copy2");
		tg.switchToTab(1);
		tg.testFunction("fnValidateAndPerformDisableInfoShare_copy2");
		tg.switchToTab(0);
