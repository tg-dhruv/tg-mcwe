...
public class digital_mytmoweb_home_bill_viewservicedetails_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_viewservicedetails_copy2() {
		tg.openBrowser();
				...
				tg.testFunction("fnNavigatetoViewServicesDetails_copy2");
		tg.close();
	}
}