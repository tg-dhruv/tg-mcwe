...
public class digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies", new Object[]{});
		tg.testFunction("fnAddMobileDeviceToCartUPGWithSkipTradeInDeclineProtection", new Object[]{});
		...
		tg.testFunction("fnRemoveMobileDeviceInCartPageAndLogout", new Object[]{});
		tg.close();
	}
}