...
public class digital_mytmoweb_home_profile_editcustomername_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_profile_editcustomername_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnEditCustomerName_copy2");
