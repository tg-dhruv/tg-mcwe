...
public class digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard {
	...
	public void digital_mytmoweb_home_bill_makefuturedatedpaymentwithcard() {
		...
		tg.testFunction("fnAssertBillAmountisGreaterthanZero");
		tg.testFunction("fnClickViewBill");
		tg.testFunction("fnOtherAmount");
		tg.testFunction("fnEnterCardDetails");
		tg.close();
	}
}