...
public class digital_mytmoweb_account_canceltsatlineban_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_canceltsatlineban_copy2() {
		tg.openBrowser();
		var_Username = tg.saveToVariable(var_TMOWebTSATUserName, var_Username);
		var_Password = tg.saveToVariable(var_TMOWebTSATPassword, var_Password);
		tg.testFunction("fnDigitalWebLoginPROD_copy2", new Object[]{});
		tg.testFunction("fnClickOnCancelTSATService_copy2", new Object[]{});
		tg.testFunction("fnDontAllowNotificationPopUp_copy2", new Object[]{});
		tg.takeFullScreenshot();
		tg.testFunction("fnCancelTSatelliteService_copy2", new Object[]{});
