...
public class digital_mytmoweb_home_plan_navigatetorateplanchange_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_plan_navigatetorateplanchange_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnViewPlanDetails_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
		tg.testFunction("fnCheckRatePlanChange_copy2");
