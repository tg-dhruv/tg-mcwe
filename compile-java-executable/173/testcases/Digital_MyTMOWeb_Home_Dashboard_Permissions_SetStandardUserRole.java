...
public class digital_mytmoweb_home_dashboard_permissions_setstandarduserrole {
	...
	public void digital_mytmoweb_home_dashboard_permissions_setstandarduserrole() {
		...
		tg.testFunction("fnClickPermissionAndControl");
		tg.testFunction("fnClickUserRoles");
		tg.testFunction("fnSetstandardUserRole");
		tg.testFunction("fnSetAuthorizedRole");
