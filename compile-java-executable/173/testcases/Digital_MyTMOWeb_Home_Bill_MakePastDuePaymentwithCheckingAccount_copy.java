...
public class digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy() {
		tg.openBrowser();
