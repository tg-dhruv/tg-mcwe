...
public class digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepastduepaymentwithcheckingaccount_copy2() {
		tg.openBrowser();
		var_Username = tg.saveToVariable("4706624138", var_Username);
		var_Password = tg.saveToVariable("Tmobile@2144", var_Password);
		tg.testFunction("fnDigitalWebLoginPRODPastDueAccount_copy2");
		tg.testFunction("fnAcceptCookies_copy2");
		tg.testFunction("fnClickViewBill_copy2");
		tg.testFunction("fnNavigatePayment_copy2");
		tg.click("ele_bankpreferred", 1);
		// [DISABLED] tg.testFunction("fnClickOnPayment_copy2");
		tg.testFunction("fnClickOnEnterAccountDetailsManually_copy2");
		tg.testFunction("fnBankAccountDetails_copy2");
