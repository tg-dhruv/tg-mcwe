...
public class digital_mytmoweb_home_bill_makeapayment_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makeapayment_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnDismissNotificationPopUps_copy2");
		tg.testFunction("fnNavigatenVerifyMakepayment_copy2");
		tg.testFunction("fnVerifyPayment_copy2");
