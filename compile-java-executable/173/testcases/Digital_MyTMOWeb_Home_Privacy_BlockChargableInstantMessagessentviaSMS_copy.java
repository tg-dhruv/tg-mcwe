...
public class digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms_copy() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies_copy");
