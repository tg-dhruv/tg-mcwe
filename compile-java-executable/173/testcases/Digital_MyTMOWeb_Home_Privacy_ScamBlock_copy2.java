...
public class digital_mytmoweb_home_privacy_scamblock_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_privacy_scamblock_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnBlockScam_copy2");
		tg.testFunction("fnValidateAndEnableScamCalls_copy2");
