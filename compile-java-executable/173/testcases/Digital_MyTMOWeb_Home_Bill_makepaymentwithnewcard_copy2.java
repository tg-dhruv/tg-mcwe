...
public class digital_mytmoweb_home_bill_makepaymentwithnewcard_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_makepaymentwithnewcard_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnOtherAmount_copy2");
		tg.testFunction("fnEnterAmount_copy2");
		tg.testFunction("fnClickOnAddPaymentMethod_copy2");
		tg.testFunction("fnClickOnCardOption_copy2");
		// [DISABLED] tg.testFunction("fnAddCardDetails_copy2");
		// [DISABLED] tg.testFunction("fnValidatePayNowButtonIsClickable_copy2");
		tg.close();
	}
}