...
public class digital_mytmoweb_home_profile_addpaymentmethodviacard {
	...
	public void digital_mytmoweb_home_profile_addpaymentmethodviacard() {
		...
		tg.testFunction("fnClickOnPaymentMethods");
		tg.testFunction("fnClickOnCardOption");
		tg.testFunction("fnAddCardDetails");
		tg.testFunction("fnDeleteCardDetails");
