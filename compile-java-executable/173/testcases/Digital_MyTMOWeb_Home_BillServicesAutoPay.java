...
public class digital_mytmoweb_home_billservicesautopay {
	...
	public void digital_mytmoweb_home_billservicesautopay() {
		...
		tg.testFunction("fnClickManageAutoPayUnderBillingService");
		tg.testFunction("fnVerifyPaymentMethodInAutoPay");
		tg.testFunction("fnVerifyCancelAutoPayInAutoPay");
		tg.testFunction("fnClickBackButton");
