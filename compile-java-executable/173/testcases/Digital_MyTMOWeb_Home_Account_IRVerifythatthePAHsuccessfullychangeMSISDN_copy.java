...
public class digital_mytmoweb_home_account_irverifythatthepahsuccessfullychangemsisdn_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_account_irverifythatthepahsuccessfullychangemsisdn_copy() {
		tg.openBrowser();
