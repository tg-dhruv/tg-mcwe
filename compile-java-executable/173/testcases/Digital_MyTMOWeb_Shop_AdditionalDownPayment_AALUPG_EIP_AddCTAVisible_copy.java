...
public class digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_additionaldownpayment_aalupg_eip_addctavisible_copy() {
		tg.openBrowser();
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies_copy", new Object[]{});
		tg.testFunction("fnAddMobileDeviceToCartUPGWithSkipTradeInDeclineProtection_copy", new Object[]{});
		...
		tg.testFunction("fnRemoveMobileDeviceInCartPageAndLogout_copy", new Object[]{});
		tg.close();
	}
}