...
public class digital_mytmoweb_home_bill_billbreakdownbyline_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_billbreakdownbyline_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnValidateMultilineBillBreakDown_copy2");
		tg.testFunction("fnDontAllowNotificationPopUp_copy2");
