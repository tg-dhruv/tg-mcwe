...
public class digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_updatenumberofpaymentsasperpaterms_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnSplitinstalmentinPA_copy2", new Object[]{});
		tg.close();
	}
}