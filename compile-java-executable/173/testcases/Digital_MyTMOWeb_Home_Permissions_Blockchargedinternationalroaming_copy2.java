...
public class digital_mytmoweb_home_permissions_blockchargedinternationalroaming_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_blockchargedinternationalroaming_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnInternationalRoaming_copy2");
		tg.testFunction("fnBlockInternationalChargedRoaming_copy2");
		tg.close();
	}
}