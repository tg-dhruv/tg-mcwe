...
public class digital_mytmoweb_home_bill_unabletoupdateschedule_copy {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_bill_unabletoupdateschedule_copy() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnManagePaymentArrangement_copy", new Object[]{});
		tg.testFunction("fnVerifyUpdateScheduleNotPresent_copy", new Object[]{});
