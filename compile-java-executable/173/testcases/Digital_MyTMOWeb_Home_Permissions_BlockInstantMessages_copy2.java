...
public class digital_mytmoweb_home_permissions_blockinstantmessages_copy2 {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_home_permissions_blockinstantmessages_copy2() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickBlockInstantMessages_copy2");
