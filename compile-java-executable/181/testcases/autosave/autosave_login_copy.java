...
public class login_copy {
	...
	public void login_copy() {
		tg.openBrowser();
				...
				if(tg.performAssert("ele_login", ComparisonType.LESS_THAN , "")){
				}
				tg.wait("ele_login608", ComparisonType.IS_VISIBLE);
				tg.wait("ele_closefrien995", ComparisonType.IS_VISIBLE);
				tg.wait("ele_closefrien326", ComparisonType.IS_VISIBLE);
				tg.click("ele_closefrien326", 1);
				tg.wait("ele_trueorigin517", ComparisonType.IS_VISIBLE);
				tg.click("ele_trueorigin517", 1);
				tg.wait("ele_seeeveryda761", ComparisonType.IS_VISIBLE);
				tg.click("ele_seeeveryda761", 1);
				...
				tg.wait("ele_logintofac331");
				tg.wait("ele_createnewa052");
