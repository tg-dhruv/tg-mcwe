...
public class digital_mytmoweb_home_profile_updateemailaddress {
	...
	public void digital_mytmoweb_home_profile_updateemailaddress() {
		...
		tg.testFunction("fnNavigateToProfileTab");
		tg.testFunction("fnClickOnBillingPreferences");
		tg.testFunction("fnClickPaperlessBilling");
		tg.testFunction("fnClickUpdateEmail");
		tg.testFunction("fnEnterEmailAddressAndSave");
