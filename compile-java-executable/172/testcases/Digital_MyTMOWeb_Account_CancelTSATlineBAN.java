...
public class digital_mytmoweb_account_canceltsatlineban {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_account_canceltsatlineban() {
		tg.openBrowser();
		...
		tg.testFunction("fnClickOnCancelTSATService", new Object[]{});
		tg.testFunction("fnDontAllowNotificationPopUp", new Object[]{});
		tg.takeFullScreenshot();
		tg.testFunction("fnCancelTSatelliteService", new Object[]{});
