...
public class digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp {
	...
	public void digital_mytmoweb_home_privacy_disablesharingofpersonaldataonthewebsiteorapp() {
		...
		tg.testFunction("fnClickOnPersonalInformation");
		tg.switchToTab(1);
		tg.testFunction("fnValidateAndPerformDisableInfoShare");
		tg.switchToTab(0);
