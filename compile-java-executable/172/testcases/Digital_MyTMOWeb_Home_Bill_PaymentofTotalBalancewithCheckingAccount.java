...
public class digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount {
	...
	public void digital_mytmoweb_home_bill_paymentoftotalbalancewithcheckingaccount() {
		...
		tg.testFunction("fnClickOnMakeAPayment");
		tg.testFunction("fnDontAllowNotificationPopUp");
		tg.testFunction("fnClickOnTotalBalance");
		tg.testFunction("fnClickOnAddPaymentMethod");
		tg.testFunction("fnClickOnBank");
		tg.testFunction("fnClickOnEnterAccountDetailsManually");
		// [DISABLED] tg.testFunction("fnFillTheAccountDetails");
		// [DISABLED] tg.testFunction("fnConfirmBankAccountDetails");
		tg.close();
	}
}