...
public class digital_mytmoweb_home_profile_updatebillingaddress {
	...
	public void digital_mytmoweb_home_profile_updatebillingaddress() {
		...
		tg.testFunction("fnUpdateBillingAddress", new Object[]{});
		// [DISABLED] tg.testFunction("fnlogoutRestored", new Object[]{});
		tg.close();
	}
}