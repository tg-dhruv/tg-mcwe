...
public class digital_mytmoweb_home_privacy_termsandconditionstab {
	...
	public void digital_mytmoweb_home_privacy_termsandconditionstab() {
		...
		tg.testFunction("fnClickOnTermsAndConditions");
		tg.switchToTab(1);
		tg.testFunction("fnValidateTermsAndConditionsHeader");
		tg.switchToTab(0);
