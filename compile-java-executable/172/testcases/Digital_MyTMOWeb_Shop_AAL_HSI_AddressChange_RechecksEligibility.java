...
public class digital_mytmoweb_shop_aal_hsi_addresschange_recheckseligibility {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_aal_hsi_addresschange_recheckseligibility() {
		tg.openBrowser();
		...
		tg.testFunction("fnTextAddressforHSILine", new Object[]{});
