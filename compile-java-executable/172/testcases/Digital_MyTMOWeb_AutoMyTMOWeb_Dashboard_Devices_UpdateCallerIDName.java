...
public class digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname {
	...
	public void digital_mytmoweb_automytmoweb_dashboard_devices_updatecalleridname() {
		...
		tg.testFunction("fnClickDeviceSettings");
		tg.testFunction("fnClickOnCallerIdName");
		tg.testFunction("fnUpdateFirstAndLastName");
