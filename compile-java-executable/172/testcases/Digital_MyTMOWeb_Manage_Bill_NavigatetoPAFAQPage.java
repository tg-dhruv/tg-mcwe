...
public class digital_mytmoweb_manage_bill_navigatetopafaqpage {
	...
	public void digital_mytmoweb_manage_bill_navigatetopafaqpage() {
		...
		tg.testFunction("fnSetupaPaymentArrangement", new Object[]{});
		tg.testFunction("fnCheckAndAddTheCreditCardInPaymentArrangementPage", new Object[]{});
		tg.wait(20);
		...
		tg.testFunction("fnValidatePAFAQPage", new Object[]{});
		tg.testFunction("fnClickBackButton", new Object[]{});
		tg.testFunction("fnClickBackButton", new Object[]{});
		tg.wait("ele_TlogoHomeNavigator", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_TlogoHomeNavigator", 1);
		tg.testFunction("fnRemovePaymentArrangement", new Object[]{});
		tg.close();
	}
}