...
public class digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline {
	...
	public void digital_mytmoweb_home_addonsandbenefits_changeaddonsfordifferentline() {
		...
		tg.testFunction("fnClickOnManageAddons");
		tg.testFunction("fnSelectAnotherLine");
		tg.testFunction("fnMultilineAddon");
		tg.testFunction("fnSelectAnotherLine");
		tg.testFunction("fnMultilineAddonRemoval");
		tg.testFunction("fnNewLogout");
		tg.close();
	}
}