...
public class digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties {
	...
	public void digital_mytmoweb_home_privacy_shareaggregatedatawiththirdparties() {
		...
		tg.testFunction("fnSharedataforpublicandscientificresearch");
		tg.testFunction("fnSharedataforpublicandscientificresearch_off");
		tg.close();
	}
}