...
public class digital_mytmoweb_shop_portin_base_shipto_verifytransferdetailsontheportintransferpage {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void digital_mytmoweb_shop_portin_base_shipto_verifytransferdetailsontheportintransferpage() {
		tg.openBrowser();
		...
		tg.testFunction("fnAddMobileToCart");
		tg.close();
	}
}