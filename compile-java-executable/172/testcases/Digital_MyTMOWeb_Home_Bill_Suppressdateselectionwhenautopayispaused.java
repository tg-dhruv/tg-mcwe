...
public class digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused {
	...
	public void digital_mytmoweb_home_bill_suppressdateselectionwhenautopayispaused() {
		...
		tg.testFunction("fnClickOnManagePaymentArrangement");
		tg.testFunction("fnAddPA");
		tg.testFunction("fnAutoPayErrorValidation");
		tg.wait("ele_backBtC", ComparisonType.IS_VISIBLE, 20);
		tg.click("ele_backBtC", 1);
		tg.testFunction("fnClickViewBill");
		tg.testFunction("fnClickOnManagePaymentArrangement");
		tg.testFunction("fnDeletePA");
