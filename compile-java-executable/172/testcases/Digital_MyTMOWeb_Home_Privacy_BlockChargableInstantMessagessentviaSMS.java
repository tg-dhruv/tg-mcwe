...
public class digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms {
	...
	public void digital_mytmoweb_home_privacy_blockchargableinstantmessagessentviasms() {
		...
		// [DISABLED] tg.testFunction("fnAcceptCookies");
		tg.testFunction("fnNaviagteToPrivacyTab");
		tg.testFunction("fnBloclcallsnMessages");
		// [DISABLED] tg.testFunction("fnBlockCallsandMessages_on");
		tg.testFunction("fnDeviceBlock");
		tg.testFunction("fnDeviceBlock");
		tg.close();
	}
}