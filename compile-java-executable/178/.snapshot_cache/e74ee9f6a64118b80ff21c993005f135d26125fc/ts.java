...
public class ts {
    ...
    public void tc_03() {
        tg.openBrowser();
        tg.wait("ele_createnewa913", ComparisonType.IS_VISIBLE);
        tg.click("ele_createnewa913", 1);
        tg.close();
    }
    ...
    public void dd001() {
        tg.openBrowser();
        tg.wait("ele_createnewa283", ComparisonType.IS_VISIBLE);
        tg.click("ele_createnewa283", 1);
        tg.close();
    }
